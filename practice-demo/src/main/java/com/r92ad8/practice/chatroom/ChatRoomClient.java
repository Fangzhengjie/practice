...
public class ChatRoomClient{
    ...
    private Map<String, ChatRoomUser> onLineUsers = new HashMap<String, ChatRoomUser>();// 所有在线用户
    ...
    public ChatRoomClient() {
        ...
        // 更改JFrame的图标：
        frame.setIconImage(Toolkit.getDefaultToolkit().createImage(ChatRoomUser.class.getResource("qq.png")));
                ...
                try {
                    ...
                    if (command.equals("CLOSE"))// 服务器已关闭命令
                    {
                        ...
                        if ((username = stringTokenizer.nextToken()) != null
                            ...
                            ChatRoomUser user = new ChatRoomUser(username, userIp);
                            onLineUsers.put(username, user);
                            listModel.addElement(username);
                        }
                    } else if (command.equals("DELETE")) {// 有用户下线更新在线列表
                        String username = stringTokenizer.nextToken();
                        ChatRoomUser user = (ChatRoomUser) onLineUsers.get(username);
